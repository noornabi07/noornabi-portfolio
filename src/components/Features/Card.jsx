...
const Card = ({ titles, descrip, icon }) => {
    return (
        ...
        data-aos-easing="linear" className='w-full px-4 md:px-12 md:py-10 h-auto md:h-80 rounded-lg shadow-shadowOne flex items-center bg-gradient-to-r from-bodyColor to-[#202327] group hover:bg-gradient-to-b hover:from-black hover:to-[#1e2024] transition-colors duration-100'>
